...
function initEventListeners() {
  ...
  document.getElementById('resetCamera').addEventListener('click', () => moveCamera('default'));
  document.getElementById('cam-wave').addEventListener('click', () => moveCamera('wave'));
  document.getElementById('cam-particle').addEventListener('click', () => moveCamera('particle'));
  document.getElementById('cam-artistic').addEventListener('click', () => moveCamera('artistic'));
  document.getElementById('cam-topdown').addEventListener('click', () => moveCamera('topdown'));
  document.getElementById('cam-follow').addEventListener('click', () => toggleFollowMode());
  
  // Info button and modal
  document.getElementById('closeInfoModal').addEventListener('click', toggleInfoModal);
  document.getElementById('infoModalBg').addEventListener('click', toggleInfoModal);
    document.getElementById('modal-overlay').addEventListener('click', toggleInfoModal);
  }
